...
export type CampaignErrorCode =
  ...
  | 'CAMPAIGN_RUN_ACTION_IDEMPOTENCY_KEY_REQUIRED'
  | 'CAMPAIGN_RUN_ACTION_IDEMPOTENCY_KEY_INVALID'
  | 'CAMPAIGN_RUN_ACTION_IDEMPOTENCY_CONFLICT'
  ...
  | 'CAMPAIGN_RUN_SESSION_NOT_FOUND'
  | 'CAMPAIGN_RUN_TIME_RANGE_INVALID'
  | 'CAMPAIGN_RUN_FILTER_MODE_INVALID'
