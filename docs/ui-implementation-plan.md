...
Current Campaign Drafts, Search & Preflight baseline: 308.14 kB JavaScript (92.59 kB gzip) and 53.11 kB CSS (10.54 kB gzip), plus 106.41 kB of locally bundled variable-font subsets. The production brand mark is an inlined SVG; native bundle icons are generated from the dedicated SVG app-icon master.
