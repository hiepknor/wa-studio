...
Current Campaign Drafts, Search & Preflight baseline: 307.97 kB JavaScript (92.51 kB gzip) and 53.26 kB CSS (10.55 kB gzip), plus 106.41 kB of locally bundled variable-font subsets. The production brand mark is an inlined SVG; native bundle icons are generated from the dedicated SVG app-icon master.
